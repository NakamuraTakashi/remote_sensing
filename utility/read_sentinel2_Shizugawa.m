%   Shizugawa area 
    ...
    filename(1)={'E:\Documents\Dropbox\collaboration\Kurihara\Shizugawa\GIS\Satellite_images\S2A_MSIL2A_20211130T012011_N0301_R031_T54SWH_20211130T034519.SAFE\geotiff\T54SWH_20211130T012011_B02_10m.tif'}; % ★★★ Band2 Blue
    filename(2)={'E:\Documents\Dropbox\collaboration\Kurihara\Shizugawa\GIS\Satellite_images\S2A_MSIL2A_20211130T012011_N0301_R031_T54SWH_20211130T034519.SAFE\geotiff\T54SWH_20211130T012011_B03_10m.tif'}; % ★★★ Band3 Green
    filename(3)={'E:\Documents\Dropbox\collaboration\Kurihara\Shizugawa\GIS\Satellite_images\S2A_MSIL2A_20211130T012011_N0301_R031_T54SWH_20211130T034519.SAFE\geotiff\T54SWH_20211130T012011_B04_10m.tif'}; % ★★★ Band4 Red
    filename(4)={'E:\Documents\Dropbox\collaboration\Kurihara\Shizugawa\GIS\Satellite_images\S2A_MSIL2A_20211130T012011_N0301_R031_T54SWH_20211130T034519.SAFE\geotiff\T54SWH_20211130T012011_B08_10m.tif'}; % ★★★ Band8 NIR
...
yrange_area = 1000:3000;  xrange_area = 3500:5500;   % ★★★★★★★★★★★★★★★★★★
...
%%
    ...
    mask(Ref_sgc(:,:,2)<0.03)=nan;   % ★★★ Greenの反射が低いところ（外洋/深いところ）をマスク（要調整） ★★★
%%
...
imshow(dl, 'DisplayRange',[0.85 1.2]);  % Relative depth image
% imshow(dl, 'DisplayRange',[1 2]);  % Relative depth image
axis on
colorbar
...
figure;
imshow(dl2, 'DisplayRange',[0.85 1.2]);  % Relative depth image
axis on
colorbar
...
figure;
imshow(dl3, 'DisplayRange',[0.85 1.2]);  % Relative depth image
axis on
colorbar
